...
> **CRITICAL:** For the module to function, you must manually create the database attribute that will store the custom tax string. This is a one-time setup.

1. Navigate to **Home > Setup > Modules/Applications**.
2. Find the **Invoices and Credit Notes** module and click its setup icon ().
...
1. Remain in the **Invoices and Credit Notes** setup area (Home > Setup > Modules/Applications > Invoices ).
